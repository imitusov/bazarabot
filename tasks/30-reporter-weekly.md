# Task 30/46: Implement `zarabot/reporter/weekly.py`
...
Module **30** of 46 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
