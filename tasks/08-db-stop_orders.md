# Task 8/40: Implement `zarabot/db/stop_orders.py`
...
Module **8** of 40 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
