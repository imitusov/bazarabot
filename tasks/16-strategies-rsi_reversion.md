# Task 16/38: Implement `zarabot/strategies/rsi_reversion.py`
...
Module **16** of 38 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
