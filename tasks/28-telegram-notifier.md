# Task 28/38: Implement `zarabot/telegram/notifier.py`
...
Module **28** of 38 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
