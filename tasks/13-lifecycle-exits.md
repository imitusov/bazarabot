# Task 13/46: Implement `zarabot/lifecycle/exits.py`
...
Module **13** of 46 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
