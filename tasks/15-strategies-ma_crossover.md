# Task 15/40: Implement `zarabot/strategies/ma_crossover.py`
...
Module **15** of 40 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
