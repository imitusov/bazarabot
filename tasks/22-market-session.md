# Task 22/43: Implement `zarabot/market/session.py`
...
Module **22** of 43 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
