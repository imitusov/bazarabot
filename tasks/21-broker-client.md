# Task 21/46: Implement `zarabot/broker/client.py`
...
Module **21** of 46 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
