# Task 21/39: Implement `zarabot/broker/client.py`
...
Module **21** of 39 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
