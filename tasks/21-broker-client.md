# Task 21/38: Implement `zarabot/broker/client.py`
...
Module **21** of 38 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
