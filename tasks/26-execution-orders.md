# Task 26/43: Implement `zarabot/execution/orders.py`
...
Module **26** of 43 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
