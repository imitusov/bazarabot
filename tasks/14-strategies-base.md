# Task 14/38: Implement `zarabot/strategies/base.py`
...
Module **14** of 38 in `dependency-order.md`. Everything before it is complete and tested — **do not modify any of it**.
