...
M = [
 ...
 (27,"broker.reconcile","zarabot/broker/reconcile.py","`broker.reconcile`",["positions","stop_orders","reconciliations"],[6,7,24,25,30],"Compares broker truth against local belief on startup. Observes and reports only - it never places or cancels an order."),
 ...
 (32,"app.startup","zarabot/app/startup.py","`app.startup`",[],[15,16,17,21,30],"Fixed startup ordering: config, logging, connection, migrations, strategies, session, order recovery, reconciliation, halt state, ready alert. 70% coverage."),
